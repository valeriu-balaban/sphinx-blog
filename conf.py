...
blog_title = u'Ph.D. Thoughts Blog'
...
blog_authors = {
    'Valeriu Balaban': ('Valeriu Balaban', None),
}
...
project = u'Ph.D. Thoughts'
copyright = u'2019, Valeriu Balaban'
author = u'Valeriu Balaban'
...
htmlhelp_basename = 'PhDThoughtsdoc'
